...
if ( ! class_exists( '__Tm_Theme_Setup' ) ) {
	...
	class __Tm_Theme_Setup {
			...
			$this->get_core()->init_module( 'cherry-post-meta', array(
				...
				'fields'        => array(
					'__tm_sidebar_position' => array(
						'type'          => 'radio',
						'title'         => esc_html__( 'Layout options', '__tm' ),
						'description'   => esc_html__( 'You can select your sidebar position (or no sidebar at this page)', '__tm' ),
						'value'         => 'inherit',
						'display_input' => false,
						'options'       => array(
							'inherit' => array(
		...
		public function enqueue_assets() {
			...
			wp_localize_script( '__tm-theme-script', '__tm', array(
