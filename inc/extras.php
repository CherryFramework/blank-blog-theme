...
function __tm_set_sidebar_position( $position ) {
	...
	$post_position = get_post_meta( $queried_obj, '__tm_sidebar_position', true );
 ...
 * @return string
 */
function __tm_set_header_layout_type( $header_layout ) {
	...
	$post_header_layout = get_post_meta( $queried_obj, '__tm_header_layout_type', true );
...
add_filter( 'theme_mod_header_layout_type', '__tm_set_header_layout_type' );
