	...
	return apply_filters( '__tm_get_customizer_options' , array(
		...
		'options'    => array(
			...
			'breadcrumbs_front_visibillity' => array(
				...
				'field'           => 'checkbox',
				'type'            => 'control',
				'active_callback' => '__tm_is_breadcrumbs_enabled',
			),
			...
			'related_posts_block_title' => array(
				...
				'field'           => 'text',
				'type'            => 'control',
				'active_callback' => '__tm_is_related_posts_enabled',
			),
...
/**
 * Return true if Breadcrumbs are enabled. Otherwise - return false.
 *
 * @param  object $control
 * @return bool
 */
function __tm_is_breadcrumbs_enabled( $control ) {
	return $control->manager->get_setting( 'breadcrumbs_visibillity' )->value();
}

/**
 * Return true if Related Posts are enabled. Otherwise - return false.
 *
 * @param  object $control
 * @return bool
 */
function __tm_is_related_posts_enabled( $control ) {
	return $control->manager->get_setting( 'related_posts_visible' )->value();
}
...
function __tm_get_default_footer_copyright() {
	return esc_html__( '&copy; %%year%% __Tm. All rights reserved.', '__tm' );
}
